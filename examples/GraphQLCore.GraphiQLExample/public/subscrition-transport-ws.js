...
var SubscriptionClient = (function () {
    ...
    SubscriptionClient.prototype.formatErrors = function (errors) {
        ...
        if (errors && errors.message) {
            return JSON.stringify({ errors: [errors] }, null, 2);
        }
        return JSON.stringify({ errors: [{ message: 'Unknown error' }] }, null, 2);
    };
    ...
    SubscriptionClient.prototype.connect = function (isReconnect) {
        ...
        this.client = new this.wsImpl(this.url/*protocols_1.GRAPHQL_SUBSCRIPTIONS DISABLE THIS TEMPORARY */ );
